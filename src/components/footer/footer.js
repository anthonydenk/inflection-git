...
const FooterComponent = ({ includeInstitutionalFootnote = false }) => {
    return (
        <div className={`footer-section ${includeInstitutionalFootnote ? "footer-section--with-footnote" : ""}`} style={{ backgroundImage: `url(${bg})` }}>
            ...
            <div className="footer-disclosure">
                ...
                {includeInstitutionalFootnote && (
                    <p className="footer-institutional-footnote">
