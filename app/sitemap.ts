...
const routes: Array<{ path: string; priority: number }> = [
  ...
  // Deliberately absent: /pre-ipo, /spacex, /resources and its guides all set
  // robots noindex. Listing a noindex URL here earns a "Submitted URL marked
  // noindex" error in Search Console, so the sitemap and the meta must agree.
